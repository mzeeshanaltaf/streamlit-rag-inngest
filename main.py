...
from custom_types import RAGSearchResult, RAGUpsertResult, RAQQueryResult, RAGChunkAndSrc
...
async def rag_ingest_pdf(ctx: inngest.Context):
    ...
    def _upsert(chunks_and_source: RAGChunkAndSrc) -> RAGUpsertResult:
...
inngest.fast_api.serve(app, inngest_client, [rag_ingest_pdf, raq_query_pdf_ai])